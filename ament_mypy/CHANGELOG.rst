...
0.17.2 (2025-04-02)
-------------------
* Add support for type stubs (`#516 <https://github.com/ament/ament_lint/issues/516>`_) (`#520 <https://github.com/ament/ament_lint/issues/520>`_)
  (cherry picked from commit 03194e1f819a8136fc3bf77bf11d39a90aac5dfd)
...
0.8.0 (2019-09-17)
------------------
* Add pytest marker for mypy (`#191 <https://github.com/ament/ament_lint/issues/191>`_)
* install manifest files in Python packages (`#185 <https://github.com/ament/ament_lint/issues/185>`_)
* add config ini to ament_mypy site package (`#182 <https://github.com/ament/ament_lint/issues/182>`_)
  * add config ini to ament_mypy site package
  * add newline to end of mypy config file
  * change to package_data vs MANIFEST.IN
...
* Contributors: Dirk Thomas, Emerson Knapp, Ted Kern
