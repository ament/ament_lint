...
if(_source_files)
  message(STATUS "Added test 'uno' to perform static code analysis on C code")

  # Get include paths for added targets
  set(_all_include_dirs "")
  set(_include_dirs "")
  if(DEFINED ament_cmake_uno_ADDITIONAL_INCLUDE_DIRS)
    list(APPEND _all_include_dirs ${ament_cmake_uno_ADDITIONAL_INCLUDE_DIRS})
  endif()
  ...
  message(STATUS "Configured uno include dirs: ${_all_include_dirs}")
  message("Configured uno include dirs: ${_all_include_dirs}")

  ament_uno(INCLUDE_DIRS ${_all_include_dirs})
endif()
